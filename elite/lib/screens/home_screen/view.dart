...
import 'courses/disaster_management.dart';
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Container(
              width: screenWidth,
              height: screenWidth > 900 ? 450 : 280,
              color: screenWidth > 900 ? Colors.amberAccent : Colors.white,
              child: LayoutBuilder(
                builder: (BuildContext context, BoxConstraints constraints) {
                  if (constraints.maxWidth > 900) {
                    return const WebCarouselSlider();
                  } else {
